...
export function Toaster() {
  ...
  const colors = {
    ...
    info: 'bg-purple-50 border-purple-200 text-purple-900 dark:bg-purple-900/20 dark:border-purple-800 dark:text-purple-100',
  };
          ...
          >
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                {toast.description && (
                  <p className="text-sm mt-1 font-medium opacity-95">{toast.description}</p>
                )}
              </div>
              <button
